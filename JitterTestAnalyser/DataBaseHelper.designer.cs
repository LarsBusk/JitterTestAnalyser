...
namespace JitterTestAnalyser
{
    ...
    partial void DeleteTestSystem(TestSystem instance);
		...
		public DataBaseHelperDataContext() : 
				base(global::JitterTestAnalyser.Properties.Settings.Default.JitterTestDataConnectionString2, mappingSource)
		{
			OnCreated();
		}
		...
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), novaVersion, mantaVersion, product, imageLength, rawDataEnabled, fODEnabled, surveilanceEnabled, statisticsEnabled, measureFrom, convSpeed, dataBaseSize, csvFile, systemID, opcClient);
			return ((int)(result.ReturnValue));
		}
	}
	...
	public partial class TestSetup : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<TestSetup> _TestSetup11;
    ...
    partial void OnCsvFileChanged();
		...
		public TestSetup()
		{
			...
			this._TestSetup11 = default(EntityRef<TestSetup>);
			OnCreated();
		}
		...
		public int SetupID
		{
			...
			set
			{
				if ((this._SetupID != value))
				{
					if (this._TestSetup11.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnSetupIDChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TestSetup_TestSetup", Storage="_TestSetup1", ThisKey="SetupID", OtherKey="SetupID", IsUnique=true, IsForeignKey=false)]
			...
			set
			{
							...
							|| (this._TestSetup1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.TestSetup11 = null;
					}
					this._TestSetup1.Entity = value;
					if ((value != null))
					{
						value.TestSetup11 = this;
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TestSetup_TestSetup", Storage="_TestSetup11", ThisKey="SetupID", OtherKey="SetupID", IsForeignKey=true)]
		public TestSetup TestSetup11
		{
			get
			{
				return this._TestSetup11.Entity;
			}
			set
			{
				TestSetup previousValue = this._TestSetup11.Entity;
				if (((previousValue != value) 
							|| (this._TestSetup11.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._TestSetup11.Entity = null;
						previousValue.TestSetup1 = null;
					}
					this._TestSetup11.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("TestSetup11");
				}
			}
		}
